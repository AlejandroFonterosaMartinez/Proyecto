...
<body>
    <div class="añadir">
        <div>
            ...
            <div id="botones">
                <button type='button' id="añadir" name="añadir" class='btn btn-outline-success'>Añadir</button>
            </div>
            <div class="tabla">
                <table class="table table-striped">
                    ...
                    <tbody class="agregar">
                        <td><textarea  id='textarea' cols='15' rows='10' class='texta'>sdfasfaf</textarea></td>
                        <td><textarea  id='textarea' cols='20' rows='10' class='texta'>sdfsfs</textarea></td>
                        <td><textarea  id='textarea' cols='5' rows='10' class='texta'>sfsafs</textarea></td>
                        <td><textarea  id='textarea' cols='5' rows='10' class='texta'>fsfsfdas</textarea></td>
                        <td><textarea  id='textarea' cols='5' rows='10' class='texta'>fasdasfsf</textarea></td>
                        <td><textarea  id='textarea' cols='30' rows='10' class='texta'>sdfsdfsdfs</textarea></td>
                        <td><textarea  id='textarea' cols='5' rows='10' class='texta'>fsdfsfs</textarea></td>
                    </tbody>
                </table>
        </div>
    ...
    <script>
        ...
        function agregar() {
            ...
            var textAreas = document.querySelectorAll('table:nth-of-type(1) textarea');
        ...
        function mostrar(fila) {
            ...
            btnWarning.forEach(editBtn => editBtn.addEventListener("click", function (e) {
                e.preventDefault;
                console.log('dentro de boton cancelar');
                cargar();
                editando--;
